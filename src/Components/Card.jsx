...
function Card() {
  return (
	...
	<div className="flex items-center justify-between p-3">
		<div className="flex items-center space-x-2">
			...
			<div className="-space-y-1">
				<h2 className="text-sm font-semibold leading-none">Prabir_07</h2>
				<span className="inline-block text-xs leading-none dark:text-gray-400">Bangalore</span>
			</div>
		</div>
	...
	<img src="https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8bGFwdG9wfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60" alt="" className="object-cover object-center w-full h-72 dark:bg-gray-500" />
	<div className="p-3">
		...
		<div className="space-y-3">
			<p className="text-sm">
				<span className="text-base font-semibold">Prabir07</span> Hello iNeuron!
			</p>
